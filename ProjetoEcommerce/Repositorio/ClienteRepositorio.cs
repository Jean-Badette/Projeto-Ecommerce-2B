        ...
        public class ClienteRepositorio(IConfiguration configuration)
        {
            ...
            public void Cadastrar(Cliente cliente)
            {
                ...
                using (var conexao = new MySqlConnection(_conexaoMySQL))
                {
                    ...
                    cmd.Parameters.Add("@telefone", MySqlDbType.VarChar).Value = cliente.TeleCli;
            ...
            public void Atualizar(Cliente cliente)
            {
                ...
                using (var conexao = new MySqlConnection(_conexaoMySQL))
                {
                    ...
                    MySqlCommand cmd = new MySqlCommand("Update cliente set NomeCli=@nome, TeleCli=@telefone, EmailCli=@email " +
            ...
            public Cliente ObterCliente(int Codigo)
            {
                ...
                using (var conexao = new MySqlConnection(_conexaoMySQL))
                {
                    ...
                    while (dr.Read())
                    {
                        ...
                        cliente.EmailCli = (string)(dr["TeleCli"]); //propriedade email e passando string
                    }
